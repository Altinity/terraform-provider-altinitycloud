...
func clickHouseClustersToSpec(clusters []*sdk.AWSEnvHostedSpecFragment_ClickHouseClusters) []common.ClickHouseClusterSpec {
...
func clickHouseKeepersToSpec(keepers []*sdk.AWSEnvHostedSpecFragment_ClickHouseKeepers) []common.ClickHouseKeeperSpec {
