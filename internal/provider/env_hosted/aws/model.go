...
type AWSEnvHostedResourceModel struct {
...
func (e AWSEnvHostedResourceModel) toSDK(ctx context.Context) (sdk.CreateAWSEnvHostedInput, sdk.UpdateAWSEnvHostedInput, diag.Diagnostics) {
	...
	var endpoints []*sdk.AWSEnvHostedEndpointSpecInput
	for _, endpoint := range e.Endpoints {
		endpoints = append(endpoints, &sdk.AWSEnvHostedEndpointSpecInput{
			ServiceName: endpoint.ServiceName.ValueString(),
			Alias:       endpoint.Alias.ValueStringPointer(),
		})
	}

	var externalBuckets []*sdk.AWSEnvHostedExternalBucketSpecInput
	for _, bucket := range e.ExternalBuckets {
		externalBuckets = append(externalBuckets, &sdk.AWSEnvHostedExternalBucketSpecInput{
	...
	var iceberg *sdk.AWSEnvHostedIcebergInputSpec
	var icebergUpdate *sdk.AWSEnvHostedIcebergUpdateInputSpec
	if e.Iceberg != nil {
		iceberg = &sdk.AWSEnvHostedIcebergInputSpec{Catalogs: catalogs}
	...
	update := sdk.UpdateAWSEnvHostedInput{
		Name:           e.Name.ValueString(),
		UpdateStrategy: &strategy,
		Spec: &sdk.AWSEnvHostedUpdateSpecInput{
			ZoneIDs:            zoneIDs,
			CustomDomains:      customDomains,
			LoadBalancers:      loadBalancers,
			NodeGroups:         nodeGroups,
...
func (model *AWSEnvHostedResourceModel) applySpec(ctx context.Context, name string, spec *sdk.AWSEnvHostedSpecFragment, specRevision int64) diag.Diagnostics {
	var allDiags diag.Diagnostics
	if spec == nil {
	...
	nodeGroupSpecKey := func(s *sdk.AWSEnvHostedSpecFragment_NodeGroups) string { return s.Name }
	...
	allDiags.Append(common.ReorderNodeGroupZones(ctx, model.NodeGroups, spec.NodeGroups,
		...
		func(s *sdk.AWSEnvHostedSpecFragment_NodeGroups) *[]string { return &s.ZoneIDs },
	)...)
	spec.MaintenanceWindows = common.ReorderByKey(model.MaintenanceWindows, spec.MaintenanceWindows,
		...
		func(s *sdk.AWSEnvHostedSpecFragment_MaintenanceWindows) string { return s.Name },
	)
	spec.Endpoints = common.ReorderByKey(model.Endpoints, spec.Endpoints,
		...
		func(s *sdk.AWSEnvHostedSpecFragment_Endpoints) string { return s.ServiceName },
	)
	spec.ExternalBuckets = common.ReorderByKey(model.ExternalBuckets, spec.ExternalBuckets,
		...
		func(s *sdk.AWSEnvHostedSpecFragment_ExternalBuckets) string { return s.Name },
	)
...
func loadBalancersToSDK(loadBalancers *LoadBalancersModel) *sdk.AWSEnvHostedLoadBalancersSpecInput {
	if loadBalancers == nil {
		return nil
	}

	var public *sdk.AWSEnvHostedLoadBalancerPublicSpecInput
	if loadBalancers.Public != nil {
		public = &sdk.AWSEnvHostedLoadBalancerPublicSpecInput{
	...
	var internal *sdk.AWSEnvHostedLoadBalancerInternalSpecInput
	if loadBalancers.Internal != nil {
		internal = &sdk.AWSEnvHostedLoadBalancerInternalSpecInput{
	...
	return &sdk.AWSEnvHostedLoadBalancersSpecInput{
		Public:   public,
		Internal: internal,
	}
}

func loadBalancersToModel(loadBalancers sdk.AWSEnvHostedSpecFragment_LoadBalancers) *LoadBalancersModel {
...
func nodeGroupsToSDK(ctx context.Context, nodeGroups []hosted.NodeGroupsModel) ([]*sdk.AWSEnvHostedNodeGroupSpecInput, diag.Diagnostics) {
	var allDiags diag.Diagnostics
	var sdkNodeGroups []*sdk.AWSEnvHostedNodeGroupSpecInput
...
func nodeGroupsToModel(nodeGroups []*sdk.AWSEnvHostedSpecFragment_NodeGroups) ([]hosted.NodeGroupsModel, diag.Diagnostics) {
	var allDiags diag.Diagnostics
...
func externalBucketsToModel(input []*sdk.AWSEnvHostedSpecFragment_ExternalBuckets) []ExternalBucketModel {
...
func backupsToSDK(backups *BackupsModel) *sdk.AWSEnvHostedBackupsSpecInput {
	if backups == nil || backups.CustomBucket == nil {
		return nil
	}

	return &sdk.AWSEnvHostedBackupsSpecInput{
		CustomBucket: &sdk.AWSEnvHostedBackupsCustomBucketSpecInput{
...
func backupsToModel(backups *sdk.AWSEnvHostedSpecFragment_Backups) *BackupsModel {
	if backups == nil || backups.CustomBucket == nil {
		return nil
	}
...
func icebergCatalogsToSDK(iceberg *IcebergModel) []*sdk.AWSEnvHostedIcebergCatalogInputSpec {
	if iceberg == nil {
		return nil
	}

	var catalogs []*sdk.AWSEnvHostedIcebergCatalogInputSpec
	for _, c := range iceberg.Catalogs {
		catalog := &sdk.AWSEnvHostedIcebergCatalogInputSpec{
			Name:                   c.Name.ValueStringPointer(),
			Type:                   sdk.AWSEnvHostedIcebergCatalogTypeSpec(c.Type.ValueString()),
		...
		if c.Maintenance != nil {
			catalog.Maintenance = &sdk.AWSEnvHostedIcebergCatalogMaintenanceInputSpec{
				Enabled: c.Maintenance.Enabled.ValueBool(),
			}
		}

		var watches []*sdk.AWSEnvHostedIcebergCatalogWatchInputSpec
		for _, w := range c.Watches {
			watches = append(watches, &sdk.AWSEnvHostedIcebergCatalogWatchInputSpec{
...
func icebergToModel(iceberg *sdk.AWSEnvHostedSpecFragment_Iceberg) *IcebergModel {
...
func reorderIceberg(model *IcebergModel, spec *sdk.AWSEnvHostedSpecFragment_Iceberg) {
	...
	spec.Catalogs = common.ReorderByKey(model.Catalogs, spec.Catalogs,
		...
		func(s *sdk.AWSEnvHostedSpecFragment_Iceberg_Catalogs) string {
	...
	for _, mc := range model.Catalogs {
		for _, sc := range spec.Catalogs {
			...
			sc.Watches = common.ReorderByKey(mc.Watches, sc.Watches,
				...
				func(s *sdk.AWSEnvHostedSpecFragment_Iceberg_Catalogs_Watches) string { return s.Table },
			)
			break
		}
	}
