...
func minimalModel() HostedAWSEnvResourceModel {
	return HostedAWSEnvResourceModel{
...
func minimalSpec() *sdk.HostedAWSEnvSpecFragment {
	return &sdk.HostedAWSEnvSpecFragment{
		Region:         "us-east-1",
		Cidr:           "10.0.0.0/16",
		ZoneIDs:        []string{"use1-az1", "use1-az2"},
		ResourcePrefix: "altinity",
		CustomDomains:  []string{},
		NodeGroups: []*sdk.HostedAWSEnvSpecFragment_NodeGroups{{
			Name:            "m6i.large",
			NodeType:        "m6i.large",
			CapacityPerZone: 1,
			ZoneIDs:         []string{"use1-az1", "use1-az2"},
		...
		MaintenanceWindows: []*sdk.HostedAWSEnvSpecFragment_MaintenanceWindows{},
		Endpoints:          []*sdk.HostedAWSEnvSpecFragment_Endpoints{},
		ExternalBuckets:    []*sdk.HostedAWSEnvSpecFragment_ExternalBuckets{},
	}
}
...
func TestApplySpec_ReordersNodeGroupsAndZonesToConfigOrder(t *testing.T) {
	...
	spec := minimalSpec()
	spec.NodeGroups = []*sdk.HostedAWSEnvSpecFragment_NodeGroups{
...
func TestApplySpec_ReordersIcebergCatalogsAndWatches(t *testing.T) {
	...
	catalogB := "b"
	spec := minimalSpec()
	spec.Iceberg = &sdk.HostedAWSEnvSpecFragment_Iceberg{
		Catalogs: []*sdk.HostedAWSEnvSpecFragment_Iceberg_Catalogs{
			{Name: &catalogA, Type: sdk.HostedAWSEnvIcebergCatalogTypeSpecS3, Watches: []*sdk.HostedAWSEnvSpecFragment_Iceberg_Catalogs_Watches{
				{Table: "t1"},
				{Table: "t2"},
			}},
			{Name: &catalogB, Type: sdk.HostedAWSEnvIcebergCatalogTypeSpecS3},
		},
	}
...
func TestApplySpec_PreservesDatadogEncAPIKey(t *testing.T) {
	...
	spec := minimalSpec()
	spec.Datadog = sdk.HostedAWSEnvSpecFragment_Datadog{Enabled: true, Domain: "datadoghq.com"}
...
func TestLoadBalancersToModel(t *testing.T) {
	got := loadBalancersToModel(sdk.HostedAWSEnvSpecFragment_LoadBalancers{
		Public: sdk.HostedAWSEnvSpecFragment_LoadBalancers_Public{
			Enabled:        true,
			SourceIPRanges: []string{"0.0.0.0/0"},
		},
		Internal: sdk.HostedAWSEnvSpecFragment_LoadBalancers_Internal{
			Enabled:                         false,
...
func TestNodeGroupsToModel(t *testing.T) {
	got, diags := nodeGroupsToModel([]*sdk.HostedAWSEnvSpecFragment_NodeGroups{{
		Name:            "m6i.large",
		NodeType:        "m6i.large",
		CapacityPerZone: 2,
		ZoneIDs:         []string{"use1-az1", "use1-az2"},
...
func TestBackupsToModel(t *testing.T) {
	...
	if got := backupsToModel(&sdk.HostedAWSEnvSpecFragment_Backups{}); got != nil {
		t.Errorf("spec without custom bucket: got %v, want nil", got)
	}

	got := backupsToModel(&sdk.HostedAWSEnvSpecFragment_Backups{
		CustomBucket: &sdk.HostedAWSEnvSpecFragment_Backups_CustomBucket{
...
func TestIcebergCatalogsToSDK(t *testing.T) {
	...
	if got[0].Type != sdk.HostedAWSEnvIcebergCatalogTypeSpecS3 {
...
func TestIcebergToModel(t *testing.T) {
	...
	if got := icebergToModel(&sdk.HostedAWSEnvSpecFragment_Iceberg{}); got != nil {
		t.Errorf("empty catalogs: got %v, want nil", got)
	}

	name := "analytics"
	bucket := "acme-iceberg"
	got := icebergToModel(&sdk.HostedAWSEnvSpecFragment_Iceberg{
		Catalogs: []*sdk.HostedAWSEnvSpecFragment_Iceberg_Catalogs{{
			Name:           &name,
			Type:           sdk.HostedAWSEnvIcebergCatalogTypeSpecS3,
			CustomS3Bucket: &bucket,
			Maintenance:    sdk.HostedAWSEnvSpecFragment_Iceberg_Catalogs_Maintenance{Enabled: true},
			Watches: []*sdk.HostedAWSEnvSpecFragment_Iceberg_Catalogs_Watches{
...
func TestReorderIcebergNilSafe(t *testing.T) {
	...
	reorderIceberg(nil, &sdk.HostedAWSEnvSpecFragment_Iceberg{})
}
...
func TestMaintenanceWindowsToModel(t *testing.T) {
	...
	got := maintenanceWindowsToModel([]*sdk.HostedAWSEnvSpecFragment_MaintenanceWindows{{
		Name:          "weekly",
		Enabled:       true,
		Hour:          2,
		LengthInHours: 4,
...
func TestEndpointsToModel(t *testing.T) {
	...
	alias := "kafka"
	got := endpointsToModel([]*sdk.HostedAWSEnvSpecFragment_Endpoints{
...
func TestExternalBucketsToModel(t *testing.T) {
	...
	got := externalBucketsToModel([]*sdk.HostedAWSEnvSpecFragment_ExternalBuckets{
